...
export const caseStudy = {
  ...
  testimonial: {
    author: { name: 'Pitsi Kagisho', role: 'Portfolio Owner' },
    content:
...
<TagList>
  <TagListItem>Responsive Web</TagListItem>
...
>
I appreciate the personalized investment strategy you crafted based on my financial goals and risk tolerance. Your expertise and proactive approach in managing my portfolio have ensured that my investments are well-diversified and aligned with my long-term objectives.
