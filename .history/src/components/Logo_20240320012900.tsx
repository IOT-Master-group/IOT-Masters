  ...
  return (
    ...
    <section className="flex items-center justify-center">
      ...
      />
        ...
        {/* <span 
        className="absolute opacity-0 duration-700 group-hover:-translate-y-10 group-hover:text-sm group-hover:text-gray-900 group-hover:opacity-100">
          IOT Masters
        </span> */}
        <span 
    className={`absolute opacity-0 duration-700 group-hover:-translate-y-10 group-hover:text-sm group-hover:opacity-100 ${darkMode ? 'text-white' : 'text-gray-900'}`}
>
    IOT Masters
</span>
