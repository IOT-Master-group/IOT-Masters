  ...
  return (
    ...
    <section className="flex items-center justify-center">
      ...
      />
        ...
        <span 
        className={invert ? 'fill-white' : 'fill-neutral-950'}className="absolute opacity-0 duration-700 group-hover:-translate-y-10 group-hover:text-sm group-hover:text-gray-900 group-hover:opacity-100">
          IOT Masters
        </span>
      </button>
    </section>
