...
export function Logo({
  ...
  return (
    ...
    <section className="flex items-center justify-center">
      <button className="group flex justify-center item rounded-md from-gray-800 p-2 font-semibold bg-yellow-300 text-white drop-shadow-xl transition-all duration-500 hover:translate-y-3 hover:rounded-[50%] hover:from-[#331029] hover:to-[#310413]">
        <svg
          viewBox="0 0 130 32"
          aria-hidden="true"
          className={clsx(fillOnHover && 'group/logo', className)}
